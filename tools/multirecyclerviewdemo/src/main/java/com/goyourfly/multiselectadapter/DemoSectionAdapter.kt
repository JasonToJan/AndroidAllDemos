...
class DemoSectionAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): RecyclerView.ViewHolder {
        if(p1 == TYPE_SECTION){
            return SectionViewHolder(LayoutInflater.from(p0.context).inflate(R.layout.item_section_multi, p0, false))
        }else{
            return MyViewHolder(LayoutInflater.from(p0.context).inflate(R.layout.item_email_multi, p0, false))
        }
    }
    ...
    class MyViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        init {
            ...
            view.findViewById<ImageView>(R.id.image_star)
                    .setOnClickListener {
