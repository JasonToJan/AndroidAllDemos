...
class MoreActivityMulti : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_more_multi)


        findViewById<Button>(R.id.demo_1).setOnClickListener {
            startActivity(Intent(it.context, Demo1Activity::class.java))
        }

        findViewById<Button>(R.id.demo_2).setOnClickListener {
            startActivity(Intent(it.context, Demo2Activity::class.java))
        }
        findViewById<Button>(R.id.demo_3).setOnClickListener {
            startActivity(Intent(it.context, Demo3Activity::class.java))
        }

        findViewById<Button>(R.id.demo_4).setOnClickListener {
            startActivity(Intent(it.context, Demo4Activity::class.java))
        }

        findViewById<Button>(R.id.demo_5).setOnClickListener {
            startActivity(Intent(it.context, Demo5Activity::class.java))
        }
        findViewById<Button>(R.id.demo_6).setOnClickListener {
            startActivity(Intent(it.context, Demo6Activity::class.java))
        }
        findViewById<Button>(R.id.demo_7).setOnClickListener {
