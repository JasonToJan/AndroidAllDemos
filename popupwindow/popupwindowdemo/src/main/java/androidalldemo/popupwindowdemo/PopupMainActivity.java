package androidalldemo.popupwindowdemo;
...
public class PopupMainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void showPopTopWithDarkBg(){
        View contentView = LayoutInflater.from(this).inflate(R.layout.pop_menu_popupwindow,null);
        //处理popWindow 显示内容
    ...
    private void showPopListView(){
        View contentView = LayoutInflater.from(this).inflate(R.layout.pop_list_popupwindow,null);
        //处理popWindow 显示内容
    ...
    private void handleListView(View contentView){
        ...
        PopupMyAdapter adapter = new PopupMyAdapter();
    ...
    private void handleLogic(View contentView){
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(PopupMainActivity.this,showContent,Toast.LENGTH_SHORT).show();
            }
        };
