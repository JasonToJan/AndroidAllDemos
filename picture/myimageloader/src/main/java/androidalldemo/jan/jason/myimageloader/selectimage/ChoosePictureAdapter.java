package androidalldemo.jan.jason.myimageloader.selectimage;
...
import androidalldemo.jan.jason.myimageloader.R;
...
public class ChoosePictureAdapter extends CommonRecyclerAdpater<String> {
    ...
    @Override
    public void bindHolder(CommonRecyclerAdpater.ViewHolder holder, final String item, int position) {
